...
public enum EngineType {
    ...
    GGP_BASE_PROVER_RULE_ENGINE(JavaEngineType.GGP_BASE_PROVER_RULE_ENGINE),
    ITERATIVE_PROVER(JavaEngineType.ITERATIVE_PROVER),
//    EMPTY_TRANSFORMED_PROVER(JavaEngineType.EMPTY_TRANSFORMED_PROVER),
...
//    REDUNDANCY_REMOVER_TRANSFORMED_PROVER(JavaEngineType.REDUNDANCY_REMOVER_TRANSFORMED_PROVER),
    ...
    PORTED_SANCHO_PROPNET(JavaEngineType.PORTED_SANCHO_PROPNET),
