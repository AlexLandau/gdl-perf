...
public enum EngineType {
    ...
    ALLOY_DUALIZED_PROVER(JavaEngineType.ALLOY_DUALIZED_PROVER),
    ALLOY_DUALIZED_COMPILED_PROVER(JavaEngineType.ALLOY_DUALIZED_COMPILED_PROVER),
    ALLOY_DUALIZED_DIFF_PROP_NET(JavaEngineType.ALLOY_DUALIZED_DIFF_PROP_NET),
